...
Perform a thorough single-company analysis by calling the available tools. Follow this workflow:
...
4. **Filings** – call `search_filings` with the user's query to find relevant filing excerpts.
