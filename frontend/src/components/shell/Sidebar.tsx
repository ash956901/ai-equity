    ...
    <nav className="h-full w-full border-r border-outline-variant bg-bg-0 flex flex-col py-lg">
      ...
      <div className={`${collapsed ? "px-0 flex justify-center" : "px-lg"} mb-xl`}>
        <div className="flex items-center gap-sm">
          <div className="w-8 h-8 bg-primary rounded flex items-center justify-center text-on-primary font-bold shrink-0">E</div>
          {!collapsed && (
            <div>
              <h1 className="text-section-header text-on-surface tracking-tight font-bold">EquityAI</h1>
