    ...
    <>
      ...
      <div className="flex flex-col gap-md sm:flex-row sm:justify-between sm:items-end mb-lg">
        ...
        <div className="flex gap-sm shrink-0">
          ...
          <PrimaryButton onClick={() => onNavigate("minerva")}>New Analysis</PrimaryButton>
        </div>
      </div>
        ...
        <Card className="lg:col-span-3 flex flex-col">
          ...
          <div className="px-lg pb-lg flex flex-col min-h-0">
            ...
            <div className="flex gap-sm mt-md pt-md border-t border-outline-variant/50">
              <button className="text-body-sm text-on-surface-variant bg-bg-2 rounded-full px-md py-xs hover:text-on-surface" onClick={() => onNavigate("minerva")}>Ask follow-up</button>
              <button className="text-body-sm text-on-surface-variant bg-bg-2 rounded-full px-md py-xs hover:text-on-surface" onClick={() => onNavigate("minerva")}>Deep dive</button>
            </div>
          </div>
        </Card>
