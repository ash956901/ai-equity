  ...
  return (
    <div>
      <div className="flex items-center gap-sm mb-sm">
        ...
        <span className="text-body-md font-semibold text-on-surface">Minerva</span>
      </div>
  ...
  const ThreadPanel = (
    <div className="flex flex-col h-full bg-bg-1 border border-outline-variant rounded-lg overflow-hidden">
      <div className="flex items-center justify-between px-md py-md border-b border-outline-variant">
        <h3 className="text-section-header text-on-surface">Minerva Threads</h3>
        <button
          onClick={() => {
            const t = newThread();
      ...
      <div className="flex-1 flex flex-col bg-bg-1 border border-outline-variant rounded-lg overflow-hidden min-w-0">
        <div className="flex items-center justify-between px-lg py-md border-b border-outline-variant">
          <div className="flex items-center gap-sm min-w-0">
            ...
            <h3 className="text-section-header text-on-surface truncate">{active?.title ?? "Minerva"}</h3>
          </div>
        ...
        <div ref={scrollRef} className="flex-1 overflow-y-auto px-lg py-lg space-y-lg">
          {active && active.messages.length === 0 ? (
            <div className="h-full flex flex-col items-center justify-center text-center">
              ...
              <h4 className="text-section-header text-on-surface">Ask Minerva anything about Indian equities</h4>
        ...
        <div className="border-t border-outline-variant p-md">
          <div className="bg-bg-0 border border-outline-variant rounded-lg focus-within:border-primary/50 transition-colors">
            <textarea
              ...
              rows={2}
              placeholder="Ask Minerva to dive deeper, compare vendors, or cite sources…"
          ...
          <p className="text-caption text-on-surface-variant text-center mt-sm">Minerva can make mistakes. Verify critical financial data against source citations.</p>
        </div>
      </div>
    </div>
  );
